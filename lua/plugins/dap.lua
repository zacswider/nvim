return {
  ...
  keys = {
    ...
    -- Widgets
    {
      ...
      mode = { 'n', 'v' },
      desc = 'Debug: [H]over (evaluate expression)',
    },
    {
      '<leader>dP',
      function()
    ...
    },
    {
      ...
      desc = 'Debug: Show Frames ([W]indow)',
    },
    {
      '<leader>dS',
      function()
    ...
    -- Python-specific
    {
      ...
      desc = 'Debug: Test [M]ethod (Python)',
    },
    {
      '<leader>dK',
      function()
    ...
    },
    {
      ...
      mode = 'v',
      desc = 'Debug: Debug [V]isual Selection (Python)',
    },
  },
  config = function()
